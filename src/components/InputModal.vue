...
<template>
    <ion-modal :is-open="isOpen" @did-dismiss="cancel">
        ...
        <ion-content>
            <ion-item>
                <ion-input v-model="todo.title" label="Toy's Name" label-placement="floating"
                    placeholder="Enter Toy's Name"></ion-input>
            </ion-item>
            <ion-item>
                <ion-textarea v-model="todo.description" label="Story" label-placement="floating"
